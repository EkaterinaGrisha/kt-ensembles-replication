...
def main():
    ...
    if args.out is None:
        args.out = paths.ARTIFACTS_DIR / "ensembles" / f"cluster_bootstrap_gating{suffix}.csv"
    if args.pooled_out is None:
        args.pooled_out = paths.ARTIFACTS_DIR / "ensembles" / f"cluster_bootstrap_gating{suffix}_pooled.csv"
